...
export class TarjetaService {
  ...
  getCardById(id:any): Observable<any>{
     return this.firestore.collection('tarjetas').doc(id).get();
  ...
  setCardById(id:any, name: string): Promise<any>{
    return this.firestore.collection('tarjetas').doc(id).set({name:name});
  }
